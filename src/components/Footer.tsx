        ...
        <div className={classes.background}>
          <Container fluid="xxl" className={classes.holder}>
            <Row className={classes.footerTopLine}>
              <Col md={4} lg={4} xl={4}>
                ...
                <div className={classes.emailForwardHolder}>
                  <div className={classes.titleForward}>Рассылка для самых любознатеьных</div>
                  <div className={classes.subtitleForward}>
                    Хочу получать больше интересных текстов, психологических разборов и секретных скидок
                  </div>
                  <div className={classes.social}>
                    <TextField
                    ...
                    <Button variant="contained" color="default" className={classes.inpuButton}>
                      Подписаться
                    </Button>
                  </div>
                </div>
              ...
              <Col className={classes.links} md={4} lg={4} xl={4}>
                <div className={classes.contacts}>
                  ...
                  <div className={classes.contact}>info@urbancenter.md</div>
                  ...
                  <div>urban@gmail.com</div>

                  <div className={classes.contactTitle}>
                    <b>Корпоративным клиентам:</b>
                  </div>
                  <div>urbaneventlab@gmail.com</div>
                </div>
              </Col>
              ...
              <Col className={classes.links} md={4} lg={4} xl={4}>
                <div className={classes.contacts}>
                  <div>
                    <b>
                      Chisinau MD, Moldova <br />
                      ул. Pan Halippa, 1
                    </b>
                  </div>
                  <div className={classes.map}>
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d340.0802587053112!2d28.828441906071518!3d47.00800058914583!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40c97e9d15c55557%3A0x306abbce760b8dbd!2sUrban%20Center!5e0!3m2!1sru!2s!4v1631514521794!5m2!1sru!2s"
                      width="300"
                      height="250"
                      style={{ border: 0 }}
                      allowfullscreen=""
                  ...
                  <div>
                    <img style={{ width: 40, height: 30, color: '#fff' }} src="../assets/visa.png" alt="" /> /
                    mastercard
                  </div>
                </div>
              </Col>
            ...
            <Row className={classes.linkCopy}>
              <Col className={classes.copy}>© Copyright 2022 Начало Жизни</Col>
            </Row>
          </Container>
        </div>
      </Hidden>
