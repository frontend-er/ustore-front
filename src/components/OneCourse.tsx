      ...
      <Card className={classes.root} style={{ backgroundColor: props.bgColor }}>
        <CardActionArea onClick={redirect}>
          <div className={classes.actionHolder}>
            ...
            <div className={classes.labelCourseHolder}>{props.label}</div>
            <Container>
              <Row>
            ...
            {props.imgLector ? (
              <CardContent>
                <div className={classes.titleHolder}>
                  {props.imgLector ? (
                    <img src={props.imgLector} alt="lector" style={{ marginRight: 20, width: 62, height: 61 }} />
                  ) : (
                    ''
                  )}
                  ...
                  {props.imgLector ? (
                    <div>
                      <div className={classes.wrapperLabelLector}>Лектор:</div>
                      <Typography gutterBottom variant="h5" component="h2" className={classes.lectorHolder}>
                        {props.lector}
                      </Typography>
                      <div className={classes.subtitle}>{props.positionLector}</div>
                    </div>
                  ) : (
                    ''
                  )}
        ...
        <CardActions>
          ...
          {props.canBeInCart !== false ? (
            <Button
              onClick={handleAddToCart}
              fullWidth
              variant="contained"
              style={{ color: '#fff', backgroundColor: props.accentColor, margin: 10 }}
            >
              В корзину +
            </Button>
          ) : (
