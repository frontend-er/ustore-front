...
function AppBurger() {
   ...
   return (
      <Fragment className={classes.holderLinks} >
         <Button
            id="menu-button"
            aria-label="Menu"
            aria-controls="menu"
            ...
            onClick={handleOpen}
         >
            <img src={burger} alt="Logo" style={{ height: 20.54, width: 20.97 }} />
         ...
         <OffCanvas
            ...
            position="right"
         >
            <Button onClick={handleClose} style={{ top: 14, right: 12, float: 'right' }}><img src={close} alt="Logo" style={{ height: 20.54, width: 20.97 }} /></Button>
            <Navigation />
         </OffCanvas>
      </Fragment >
   )
...
export default observer(AppBurger)