...
import relationship from '../assets/CoursesMini/Youth/relationship.png'
            ...
            <div className={classes.root}>
               ...
               <Container>
                  ...
                  <Row style={{ marginTop: 80 }}>
                     ...
                     <Col>
                        <OneCourse id={11} title='“Игратин”' bgColor='#E8E6F0' label=" Urban Youth" lector='Сергей Прокопов' positionLector="Социальный педагог" tags='youth' price={100} imgLector={VGrecov} img={igratin} description="На курсе изучаем, как понимать себя, свои ресурсы и управлять ими. Помогаем ответить на вопрос: «Что делать после окончания школы?»" accentColor='#100267' />
               ...
               <Container style={{ marginBottom: 60 }}>
                  <Row style={{ marginBottom: 60 }}>
                     <Col>
                        <div className={classes.sliderTitle}> Все от <span className={classes.decoratrionTitle}> Urban Youth: </span>  </div>
                     </Col>
                  </Row>
                  <Row>
                     <Col>
                        ...
                        <Row>
                           <Col xs={4}>
                              <OneCourse id={9} title='“Отношения по замыслу Творца”' bgColor='#E8E6F0' label=" Urban Youth" lector='Сергей Прокопов' positionLector="Социальный педагог" tags='youth' price={100} imgLector={SProcopov} img={PrepareToSucces} description="Курс подготовки к браку христианской молодежи. Поднимаем основные вопросы, которые волнуют современную молодежь." accentColor='#100267' />


                           </Col>
                           <Col xs={4} >
                              <OneCourse id={8} title='“Подготовка к успеху”' bgColor='#E8E6F0' label=" Urban Youth" lector='Сергей Прокопов' positionLector="Социальный педагог" tags='youth' price={100} imgLector={SProcopov} img={relationship} description="На курсе изучаем, как понимать себя, свои ресурсы и управлять ими. Помогаем ответить на вопрос: «Что делать после окончания школы?»" accentColor='#100267' />


                           </Col>
                           <Col xs={4} >

                              <OneCourse id={11} title='“Игратин”' bgColor='#E8E6F0' label=" Urban Youth" lector='Виталий Греков' positionLector="Разработчик развивающего досуга" tags='youth' price={100} imgLector={VGrecov} img={igratin} description="Новое слово развивающего досуга- игратин. Создание интерактивной игры в онлайн формате." accentColor='#100267' />
                        ...
                        <Row>
                           <Col xs={4}>
                              <OneCourse id={10} title='“Равноценное лидерство”' bgColor='#E8E6F0' label=" Urban Youth" lector='Сергей Прокопов' positionLector="Социальный педагог" tags='youth' price={100} imgLector={SProcopov} img={leadership} description="Формирование лидеров нового поколения, обладающих здоровой самооценкой, умеющих работать в команде ради достижения общей цели и позитивных изменений в сообществе." accentColor='#100267' />
